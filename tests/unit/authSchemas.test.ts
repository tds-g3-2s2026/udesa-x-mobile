...
describe('Registration', () => {
  ...
  it('requires the handle to start with @', () => {
  ...
  it('accepts a password with 8 characters, an uppercase letter and a number', () => {
  ...
  it('rejects a registration with every required field empty', () => {
  ...
  it('rejects required fields that only contain whitespace', () => {
    expect(registerErrorFor('fullName', '   ')).not.toBeNull();
    expect(registerErrorFor('email', '   ')).not.toBeNull();
  });

  it('rejects a login with empty fields', () => {
  ...
  it('accepts a verification code of exactly 6 digits', () => {
...
describe('Sign in', () => {
  it('accepts credentials with an identifier and a password', () => {
  ...
  it('accepts an email as identifier and trims surrounding spaces', () => {
...
describe('Forgot password', () => {
  ...
  it('accepts an email or a handle as request identifier', () => {
  ...
  it('accepts a reset whose confirmation matches and meets the policy', () => {
    expect(resetPasswordSchema.safeParse(validReset).success).toBe(true);
  });

  it('rejects a confirmation that does not match and marks the second field', () => {
  ...
  it('requires the token that arrives by email and trims what was pasted', () => {
